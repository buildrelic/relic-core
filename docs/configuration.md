---
title: "Configuration"
description: "Environment variables, the four stores, secret handling, and the doctor report."
---
...
- **The ingest checkpoint.** A per-repo ledger at `./data/ingest/<group_id>.log`,
  ...
  resume a failed run. `ingest --fresh` clears it. See [ingestion.md](/ingestion).
