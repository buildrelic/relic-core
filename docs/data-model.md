...
```json
{
  ...
  "reviews": [{"login": "...", "profile_url": "...", "state": "approved", "submitted_at": "...", "url": "...", "comment": "..."}],
  "requested_reviewers": ["..."],
...
description, state, url, assignees, and labels. The same shape covers GitHub and
...
[`examples/skills/pr-review-routing.json`](../examples/skills/pr-review-routing.json).
