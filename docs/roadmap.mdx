...
finished session back into the engram as an AgentSession episode (the new artifact type,
...
PRs, capture lands an AgentSession episode, and recall surfaces it. The daemon reuses the
